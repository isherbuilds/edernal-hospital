...
| **Reference**             | [reference/schema-menu.md](./reference/schema-menu.md)                                                            | The distilled schema pack: deferred RLS reference + per-domain table shapes to pull from per phase, simplified.                     |
...
4. **[adr/](./adr/)** — decisions and why:
   ...
   - [0003](./adr/0003-single-vps-app-tenancy.md) — single VPS/Coolify, one Postgres, app-enforced tenant scoping
